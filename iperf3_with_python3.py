...
"""
The bottom line is easy:

$ iperf3 -R -P10  -p 5207 -t3 -4  --format m -c ams.speedtest.clouvider.net | grep SUM | grep receiver
[SUM]   0.00-3.00   sec  25.9 MBytes  72.6 Mbits/sec                  receiver

The devil is in the details: find closest iperf3 server, choose a random port, etc
...
def ipv4_ipv6_speed():
    ...
    # print("Done")
    return ipv4_speed, ipv6_speed


if __name__ == "__main__":
    print(ipv4_ipv6_speed())
